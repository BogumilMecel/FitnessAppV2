...
data class Recipe(
    ...
    @ColumnInfo(name = "time_required") val timeRequired: TimeRequired = TimeRequired.LOW,
    @ColumnInfo(name = "difficulty") val difficulty: Difficulty = Difficulty.LOW,
    @ColumnInfo(name = "servings") val servings: Int = 0,
