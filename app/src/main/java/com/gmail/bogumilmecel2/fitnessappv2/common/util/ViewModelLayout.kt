...
@Composable
inline fun <EVENT : Any, NAV_ARGUMENTS : Any> BaseViewModel2<EVENT, NAV_ARGUMENTS>.ViewModelLayout2(
    navigator: DestinationsNavigator,
    screenTestTag: String? = null,
    content: @Composable BaseViewModel2<EVENT, NAV_ARGUMENTS>.() -> Unit = { }
) {
    Box(
        modifier = screenTestTag?.let { tag ->
            Modifier.testTag(tag)
...
@Composable
inline fun <EVENT : Any, NAV_ARGUMENTS : Any, RESULT_BACK : Any> BaseResultViewModel2<EVENT, NAV_ARGUMENTS, RESULT_BACK>.ViewModelLayout2(
    navigator: DestinationsNavigator,
    resultBackNavigator: ResultBackNavigator<RESULT_BACK>,
    content: @Composable BaseViewModel2<EVENT, NAV_ARGUMENTS>.() -> Unit = { }
) {
